...
Система для анализа и взвешивания свиней с использованием компьютерного зрения. Новая архитектура оптимизирована для реального времени с поддержкой WebRTC и декуплинга стримов от инференса.
